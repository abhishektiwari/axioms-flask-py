...
from axioms_flask.decorators import has_required_scopes, has_valid_access_token
...
def generate_jwt_token(key, claims, alg="RS256"):
    ...
    token = jwcrypto_jwt.JWT(header={"alg": alg, "kid": key.kid}, claims=claims)
...
class TestAlgorithmValidation:
    ...
    def test_reject_missing_kid(self, client, test_key):
        ...
        token_obj = jwcrypto_jwt.JWT(
            header={"alg": "RS256"}, claims=claims  # Missing 'kid'
        )
